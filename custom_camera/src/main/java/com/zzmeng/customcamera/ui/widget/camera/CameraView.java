...
import com.zzmeng.customcamera.ui.widget.camera.api14.Camera1;
import com.zzmeng.customcamera.ui.widget.camera.base.AspectRatio;
import com.zzmeng.customcamera.ui.widget.camera.base.CameraViewImpl;
...
/**
 * Create by chenzhuang on 2018/4/25 0025 下午 5:26
 */
public class CameraView extends FrameLayout {
    ...
    public CameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        screenWidth = UIUtils.INSTANCE.getScreenWidth(context);
        screenHeight = UIUtils.INSTANCE.getScreenHeight(context);
        if (isInEditMode()) {
            mCallbacks = null;
        ...
        //  这里使用老版的Camera，新版的会有问题
        mImpl = new Camera1(mCallbacks, preview);
//        if (checkSystem() || Build.VERSION.SDK_INT < 21) {
//            mImpl = new Camera1(mCallbacks, preview);
