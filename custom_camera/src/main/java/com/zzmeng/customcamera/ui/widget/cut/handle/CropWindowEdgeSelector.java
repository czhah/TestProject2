...
public enum CropWindowEdgeSelector {
    ...
    //双指缩放
    POINTERS(new CropWindowPointersHelper());
    ...
    public void updateCropWindow(@NonNull MotionEvent event, @NonNull PointF touchOffsetOutput, @NonNull RectF imageRect, int cropType) {

        mHelper.updateCropWindow(event, touchOffsetOutput, imageRect, cropType);
    }
