...
package com.zzmeng.customcamera.ui.widget.cut.util;
...
public class CatchEdgeUtil {
     ...
     */
    public static CropWindowEdgeSelector getPressedHandle(MotionEvent event,
                                                          int pointers,
                                                          float left,
                                                          float top,
                                                          float right,
        ...
        if (pointers >= 2) {
            nearestCropWindowEdgeSelector = CropWindowEdgeSelector.POINTERS;
            return nearestCropWindowEdgeSelector;
        }

        if (cropType == 1) {
            nearestCropWindowEdgeSelector = CropWindowEdgeSelector.CENTER;
            return nearestCropWindowEdgeSelector;
        }
